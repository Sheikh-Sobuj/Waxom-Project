...
window.Element && !Element.prototype.closest && (Element.prototype.closest = function(e) {
        var t, a = (this.document || this.ownerDocument).querySelectorAll(e), i = this;
        do {
            for (t = a.length; 0 <= --t && a.item(t) !== i; )
                ;
    ...
    function(e, t) {
        "function" == typeof define && define.amd ? define([], (function() {
            ...
            var t = {
                ...
                for (var t, a = String(e), i = a.length, r = -1, s = "", n = a.charCodeAt(0); ++r < i; ) {
                    if (0 === (t = a.charCodeAt(r)))
                        throw new InvalidCharacterError("Invalid character: the input contains U+0000.");
                    s += 1 <= t && t <= 31 || 127 == t || 0 === r && 48 <= t && t <= 57 || 1 === r && 48 <= t && t <= 57 && 45 === n ? "\\" + t.toString(16) + " " : 128 <= t || 45 === t || 95 === t || 48 <= t && t <= 57 || 65 <= t && t <= 90 || 97 <= t && t <= 122 ? a.charAt(r) : "\\" + a.charAt(r)
                }
                return "#" + s
            }
                , r = function() {
            ...
            return function(n, o) {
                ...
                u.animateScroll = function(i, n, o) {
                    u.cancelScroll();
                    var d = a(l || t, o || {})
                        , h = "[object Number]" === Object.prototype.toString.call(i)
                        , f = h || !i.tagName ? null : i;
                    if (h || f) {
                        var v = e.pageYOffset;
                        d.header && !p && (p = document.querySelector(d.header));
                        var m, g, w, y, b, E, x, T, S = function(t) {
                            return t ? (a = t,
                            parseInt(e.getComputedStyle(a).height, 10) + t.offsetTop) : 0;
                            var a
                        }(p), C = h ? i : function(t, a, i, s) {
                            var n = 0;
                            if (t.offsetParent)
                                for (; n += t.offsetTop,
                                           t = t.offsetParent; )
                                    ;
                            return n = Math.max(n - a - i, 0),
                            s && (n = Math.min(n, r() - e.innerHeight)),
                                n
                        }(f, S, parseInt("function" == typeof d.offset ? d.offset(i, n) : d.offset, 10), d.clip), M = C - v, z = r(), P = 0, k = (m = M,
                            w = (g = d).speedAsDuration ? g.speed : Math.abs(m / 1e3 * g.speed),
                            g.durationMax && w > g.durationMax ? g.durationMax : g.durationMin && w < g.durationMin ? g.durationMin : parseInt(w, 10)), L = function(t) {
                            var a, r, o;
                            y || (y = t),
                                P += t - y,
                                E = v + M * (r = b = 1 < (b = 0 === k ? 0 : P / k) ? 1 : b,
                                "easeInQuad" === (a = d).easing && (o = r * r),
                                "easeOutQuad" === a.easing && (o = r * (2 - r)),
                                "easeInOutQuad" === a.easing && (o = r < .5 ? 2 * r * r : (4 - 2 * r) * r - 1),
                                "easeInCubic" === a.easing && (o = r * r * r),
                                "easeOutCubic" === a.easing && (o = --r * r * r + 1),
                                "easeInOutCubic" === a.easing && (o = r < .5 ? 4 * r * r * r : (r - 1) * (2 * r - 2) * (2 * r - 2) + 1),
                                "easeInQuart" === a.easing && (o = r * r * r * r),
                                "easeOutQuart" === a.easing && (o = 1 - --r * r * r * r),
                                "easeInOutQuart" === a.easing && (o = r < .5 ? 8 * r * r * r * r : 1 - 8 * --r * r * r * r),
                                "easeInQuint" === a.easing && (o = r * r * r * r * r),
                                "easeOutQuint" === a.easing && (o = 1 + --r * r * r * r * r),
                                "easeInOutQuint" === a.easing && (o = r < .5 ? 16 * r * r * r * r * r : 1 + 16 * --r * r * r * r * r),
                                a.customEasing && (o = a.customEasing(r)),
                                o || r),
                                e.scrollTo(0, Math.floor(E)),
                            function(t, a) {
                                var r, o, l, p = e.pageYOffset;
                                if (t == a || p == a || (v < a && e.innerHeight + p) >= z)
                                    return u.cancelScroll(!0),
                                        o = a,
                                        l = h,
                                    0 === (r = i) && document.body.focus(),
                                    l || (r.focus(),
                                    document.activeElement !== r && (r.setAttribute("tabindex", "-1"),
                                        r.focus(),
                                        r.style.outline = "none"),
                                        e.scrollTo(0, o)),
                                        s("scrollStop", d, i, n),
                                        !(c = y = null)
                            }(E, C) || (c = e.requestAnimationFrame(L),
                                y = t)
                        };
                        0 === e.pageYOffset && e.scrollTo(0, 0),
                            x = i,
                            T = d,
                        h || history.pushState && T.updateURL && history.pushState({
                            smoothScroll: JSON.stringify(T),
                            anchor: x.id
                        }, document.title, x === document.documentElement ? "#top" : "#" + x.id),
                            "matchMedia"in e && e.matchMedia("(prefers-reduced-motion)").matches ? e.scrollTo(0, Math.floor(C)) : (s("scrollStart", d, i, n),
                                u.cancelScroll(!0),
                ...
                ;
                var h = function(t) {
                    if (!t.defaultPrevented && !(0 !== t.button || t.metaKey || t.ctrlKey || t.shiftKey) && "closest"in t.target && (d = t.target.closest(n)) && "a" === d.tagName.toLowerCase() && !t.target.closest(l.ignore) && d.hostname === e.location.hostname && d.pathname === e.location.pathname && /#/.test(d.href)) {
                        var a, r;
                        try {
                            a = i(decodeURIComponent(d.hash))
                        } catch (t) {
                            a = i(d.hash)
                        }
                        if ("#" === a) {
                        ...
                        (r = r || "#top" !== a ? r : document.documentElement) && (t.preventDefault(),
                            function(t) {
                                if (history.replaceState && t.updateURL && !history.state) {
                                    ...
                                    a = a || "",
                                        ...
                                        }, document.title, a || e.location.href)
                                }
                            }(l),
                            u.animateScroll(r, d))
                    }
                    ...
                    if (null !== history.state && history.state.smoothScroll && history.state.smoothScroll === JSON.stringify(l)) {
                        ...
                        "string" == typeof t && t && !(t = document.querySelector(i(history.state.anchor))) || u.animateScroll(t, null, {
                            updateURL: !1
                        })
                    }
                };
                return u.destroy = function() {
                    ...
                    function() {
                        ...
                        u.destroy(),
                            l = a(t, o || {}),
                            p = l.header ? document.querySelector(l.header) : null,
    ...
    function(e, t) {
        "object" == typeof exports && "undefined" != typeof module ? module.exports = t() : "function" == typeof define && define.amd ? define(t) : (e = "undefined" != typeof globalThis ? globalThis : e || self).Swiper = t()
                        ...
                        for (var d = o[l], p = 0; p < this.length; p += 1) {
                            ...
                            u && u.length)
                                for (var h = u.length - 1; h >= 0; h -= 1) {
                                    var f = u[h];
                                    s && f.listener === s || s && f.listener && f.listener.dom7proxy && f.listener.dom7proxy === s ? (c.removeEventListener(d, f.proxyListener, n),
                                        u.splice(h, 1)) : s || (c.removeEventListener(d, f.proxyListener, n),
                                        u.splice(h, 1))
                                }
                        }
                    return this
            ...
            function T(e, t) {
                void 0 === t && (t = "x");
                var a, i, r, s = o(), n = s.getComputedStyle(e, null);
            ...
            function C() {
                for (var e = Object(arguments.length <= 0 ? void 0 : arguments[0]), t = 1; t < arguments.length; t += 1) {
                    ...
                    if (null != a)
                        for (var i = Object.keys(Object(a)), r = 0, s = i.length; r < s; r += 1) {
                            var n = i[r]
                                , o = Object.getOwnPropertyDescriptor(a, n);
                            void 0 !== o && o.enumerable && (S(e[n]) && S(a[n]) ? C(e[n], a[n]) : !S(e[n]) && S(a[n]) ? (e[n] = {},
                                C(e[n], a[n])) : e[n] = a[n])
                        }
                }
                return e
            ...
            function P(e) {
                ...
                w || (w = function(e) {
                    var t = (void 0 === e ? {} : e).userAgent
                        ...
                        , f = "Win32" === r
                        , v = "MacIntel" === r;
                    return !c && v && a.touch && ["1024x1366", "1366x1024", "834x1194", "1194x834", "834x1112", "1112x834", "768x1024", "1024x768", "820x1180", "1180x820", "810x1080", "1080x810"].indexOf(l + "x" + d) >= 0 && ((c = s.match(/(Version)\/([\d.]+)/)) || (c = [0, 1, "13_0_0"]),
                        v = !1),
                    p && !f && (n.os = "android",
                        n.android = !0),
                    (c || h || u) && (n.os = "ios",
            ...
            function O(e) {
                ...
                if (!t.animating || !n.preventInteractionOnTransition) {
                    ...
                    var p = m(d.target);
                    if (("wrapper" !== n.touchEventsTarget || p.closest(t.wrapperEl).length) && (r.isTouchEvent = "touchstart" === d.type,
                    (r.isTouchEvent || !("which"in d) || 3 !== d.which) && !(!r.isTouchEvent && "button"in d && d.button > 0 || r.isTouched && r.isMoved)))
                        ...
                        n.noSwiping && p.closest(n.noSwipingSelector ? n.noSwipingSelector : "." + n.noSwipingClass)[0])
                            ...
                            "touchstart" !== d.type) {
                                var v = !0;
                                p.is(r.formElements) && (v = !1),
                                a.activeElement && m(a.activeElement).is(r.formElements) && a.activeElement !== p[0] && a.activeElement.blur();
                ...
                if (l.originalEvent && (l = l.originalEvent),
                    ...
                    if (!i.isTouchEvent || "touchmove" === l.type) {
                        ...
                        if (i.allowTouchCallbacks && a.emit("touchMove", l),
                            ...
                            n.currentX = p,
                                n.currentY = c;
                            var u, h = n.currentX - n.startX, f = n.currentY - n.startY;
                            if (!(a.params.threshold && Math.sqrt(Math.pow(h, 2) + Math.pow(f, 2)) < a.params.threshold))
                                if (void 0 === i.isScrolling && (a.isHorizontal() && n.currentY === n.startY || a.isVertical() && n.currentX === n.startX ? i.isScrolling = !1 : h * h + f * f >= 25 && (u = 180 * Math.atan2(Math.abs(f), Math.abs(h)) / Math.PI,
                                    i.isScrolling = a.isHorizontal() ? u > r.touchAngle : 90 - u > r.touchAngle)),
                                ...
                                void 0 === i.startMoving && (n.currentX === n.startX && n.currentY === n.startY || (i.startMoving = !0)),
                                    ...
                                    if (r.touchReleaseOnEdges && (w = 0),
                                        v > 0 && i.currentTranslate > a.minTranslate() ? (g = !1,
                                        r.resistance && (i.currentTranslate = a.minTranslate() - 1 + Math.pow(-a.minTranslate() + i.startTranslate + v, w))) : v < 0 && i.currentTranslate < a.maxTranslate() && (g = !1,
                                        r.resistance && (i.currentTranslate = a.maxTranslate() + 1 - Math.pow(a.maxTranslate() - i.startTranslate - v, w))),
                ...
                if (a.isTouched = !1,
                    ...
                    if (i.freeMode) {
                        ...
                        if (i.freeModeMomentum) {
                            ...
                            if (y < t.maxTranslate())
                                i.freeModeMomentumBounce ? (y + t.maxTranslate() < -C && (y = t.maxTranslate() - C),
                                    b = t.maxTranslate(),
                                    S = !0,
                                    a.allowMomentumBounce = !0) : y = t.maxTranslate(),
                                i.loop && i.centeredSlides && (T = !0);
                            else if (y > t.minTranslate())
                                i.freeModeMomentumBounce ? (y - t.minTranslate() > C && (y = t.minTranslate() + C),
                                    b = t.minTranslate(),
                                    S = !0,
                            ...
                            0 !== t.velocity) {
                                if (g = s ? Math.abs((-y - t.translate) / t.velocity) : Math.abs((y - t.translate) / t.velocity),
                                    i.freeModeSticky) {
                            ...
                            i.freeModeMomentumBounce && S ? (t.updateProgress(b),
                                t.setTransition(g),
                                t.setTranslate(y),
                        ...
                        if (u > i.longSwipesMs) {
                            ...
                            if (!i.shortSwipes)
                                return void t.slideTo(t.activeIndex);
                            !t.navigation || d.target !== t.navigation.nextEl && d.target !== t.navigation.prevEl ? ("next" === t.swipeDirection && t.slideTo(L + D),
                            "prev" === t.swipeDirection && t.slideTo(L)) : d.target === t.navigation.nextEl ? t.slideTo(L + D) : t.slideTo(L)
                        }
                    }
            }
            function N() {
            ...
            var R = {
                ...
                update: {
                    ...
                    updateSlides: function() {
                        ...
                        if (void 0 !== n) {
                            ...
                            r.slidesPerColumn > 1 && (M = Math.floor(h / r.slidesPerColumn) === h / e.params.slidesPerColumn ? h : Math.ceil(h / r.slidesPerColumn) * r.slidesPerColumn,
                            "auto" !== r.slidesPerView && "row" === r.slidesPerColumnFill && (M = Math.max(M, r.slidesPerView * r.slidesPerColumn)));
                            for (var P, k, L, $ = r.slidesPerColumn, I = M / $, O = Math.floor(h / r.slidesPerColumn), A = 0; A < h; A += 1) {
                                z = 0;
                                var D = u.eq(A);
                                if (r.slidesPerColumn > 1) {
                                    ...
                                    if ("row" === r.slidesPerColumnFill && r.slidesPerGroup > 1) {
                                        var B = Math.floor(A / (r.slidesPerGroup * r.slidesPerColumn))
                                            , Y = A - r.slidesPerColumn * r.slidesPerGroup * B
                                            , R = 0 === B ? r.slidesPerGroup : Math.min(Math.ceil((h - B * $ * r.slidesPerGroup) / $), r.slidesPerGroup);
                                        N = (G = Y - (H = Math.floor(Y / R)) * R + B * r.slidesPerGroup) + H * M / $,
                                            D.css({
                                        ...
                                        "column" === r.slidesPerColumnFill ? (H = A - (G = Math.floor(A / $)) * $,
                                        (G > O || G === O && H === $ - 1) && (H += 1) >= $ && (H = 0,
                                            G += 1)) : G = A - (H = Math.floor(A / I)) * I;
                                    D.css(t("margin-top"), 0 !== H && r.spaceBetween && r.spaceBetween + "px")
                                }
                                if ("none" !== D.css("display")) {
                                    if ("auto" === r.slidesPerView) {
                                        var X = i.getComputedStyle(D[0], null)
                                            , F = D[0].style.transform
                                            , V = D[0].style.webkitTransform;
                                        if (F && (D[0].style.transform = "none"),
                                        V && (D[0].style.webkitTransform = "none"),
                                            ...
                                            var W = a(X, "width")
                                                ...
                                                , _ = a(X, "margin-left")
                                                , U = a(X, "margin-right")
                                                , K = X.getPropertyValue(X, "box-sizing");
                                            if (K && "border-box" === K)
                                                z = W + _ + U;
                                            else {
                                                var Q = D[0]
                                                    , J = Q.clientWidth;
                                                z = W + q + j + _ + U + (Q.offsetWidth - J)
                                            }
                                        }
                                        F && (D[0].style.transform = F),
                                        V && (D[0].style.webkitTransform = V),
                                        r.roundLengths && (z = Math.floor(z))
                                    } else
                                        z = (n - (r.slidesPerView - 1) * E) / r.slidesPerView,
                                        r.roundLengths && (z = Math.floor(z)),
                                        u[A] && (u[A].style[t("width")] = z + "px");
                                    u[A] && (u[A].swiperSlideSize = z),
                                        m.push(z),
                                        r.centeredSlides ? (x = x + z / 2 + T / 2 + E,
                                        0 === T && 0 !== A && (x = x - n / 2 - E),
                                        0 === A && (x = x - n / 2 - E),
                                        Math.abs(x) < .001 && (x = 0),
                                        r.roundLengths && (x = Math.floor(x)),
                                        S % r.slidesPerGroup == 0 && f.push(x),
                                            v.push(x)) : (r.roundLengths && (x = Math.floor(x)),
                            ...
                            l && d && ("slide" === r.effect || "coverflow" === r.effect) && s.css({
                                width: e.virtualSize + r.spaceBetween + "px"
                            }),
                            r.setWrapperSize && s.css(((k = {})[t("width")] = e.virtualSize + r.spaceBetween + "px",
                                k)),
                            r.slidesPerColumn > 1 && (e.virtualSize = (z + r.spaceBetween) * M,
                                e.virtualSize = Math.ceil(e.virtualSize / r.slidesPerColumn) - r.spaceBetween,
                                s.css(((L = {})[t("width")] = e.virtualSize + r.spaceBetween + "px",
                                    L)),
                                r.centeredSlides)) {
                                P = [];
                                for (var Z = 0; Z < f.length; Z += 1) {
                                    ...
                                    f[Z] < e.virtualSize + f[0] && P.push(ee)
                                }
                                f = P
                            }
                            if (!r.centeredSlides) {
                                ...
                                for (var te = 0; te < f.length; te += 1) {
                                    var ae = f[te];
                                    r.roundLengths && (ae = Math.floor(ae)),
                                    f[te] <= e.virtualSize - n && P.push(ae)
                                }
                                f = P,
                            ...
                            if (0 === f.length && (f = [0]),
                            0 !== r.spaceBetween) {
                                var ie, re = e.isHorizontal() && l ? "marginLeft" : t("marginRight");
                    ...
                    updateSlidesClasses: function() {
                        ...
                        a.removeClass(i.slideActiveClass + " " + i.slideNextClass + " " + i.slidePrevClass + " " + i.slideDuplicateActiveClass + " " + i.slideDuplicateNextClass + " " + i.slideDuplicatePrevClass),
                            (e = o ? t.$wrapperEl.find("." + i.slideClass + '[data-swiper-slide-index="' + s + '"]') : a.eq(s)).addClass(i.slideActiveClass),
                    ...
                    updateActiveIndex: function(e) {
                        ...
                        if (void 0 === p) {
                            for (var c = 0; c < r.length; c += 1)
                                void 0 !== r[c + 1] ? i >= r[c] && i < r[c + 1] - (r[c + 1] - r[c]) / 2 ? p = c : i >= r[c] && i < r[c + 1] && (p = c + 1) : i >= r[c] && (p = c);
                    ...
                    updateClickedSlide: function(e) {
                        var t, a = this, i = a.params, r = m(e.target).closest("." + i.slideClass)[0], s = !1;
                        if (r)
                        ...
                        a.clickedSlide = r,
                            a.virtual && a.params.virtual.enabled ? a.clickedIndex = parseInt(m(r).attr("data-swiper-slide-index"), 10) : a.clickedIndex = t,
                ...
                translate: {
                    ...
                    setTranslate: function(e, t) {
                        ...
                        r.roundLengths && (l = Math.floor(l),
                            d = Math.floor(d)),
                            r.cssMode ? n[a.isHorizontal() ? "scrollLeft" : "scrollTop"] = a.isHorizontal() ? -l : -d : r.virtualTranslate || s.transform("translate3d(" + l + "px, " + d + "px, 0px)"),
                ...
                slide: {
                    slideTo: function(e, t, a, i) {
                        ...
                        (c || o.initialSlide || 0) === (p || 0) && a && s.emit("beforeSlideChangeStart");
                        var m, g = -l[v];
                        ...
                        if (s.initialized && n !== c) {
                            if (!s.allowSlideNext && g < s.translate && g < s.minTranslate())
                                return !1;
                            if (!s.allowSlidePrev && g > s.translate && g > s.maxTranslate() && (c || 0) !== n)
                                return !1
                        }
                        if (m = n > c ? "next" : n < c ? "prev" : "reset",
                        u && -g === s.translate || !u && g === s.translate)
                            return s.updateActiveIndex(n),
                            o.autoHeight && s.updateAutoHeight(),
                                s.updateSlidesClasses(),
                            "slide" !== o.effect && s.setTranslate(g),
                            "reset" !== m && (s.transitionStart(a, m),
                                s.transitionEnd(a, m)),
                                !1;
                        if (o.cssMode) {
                            var x, T = s.isHorizontal(), S = -g;
                            return u && (S = h.scrollWidth - h.offsetWidth - S),
                                0 === t ? h[T ? "scrollLeft" : "scrollTop"] = S : h.scrollTo ? h.scrollTo(((x = {})[T ? "left" : "top"] = S,
                                    x.behavior = "smooth",
                                    x)) : h[T ? "scrollLeft" : "scrollTop"] = S,
                                !0
                        }
                        return 0 === t ? (s.setTransition(0),
                            s.setTranslate(g),
                            ...
                            s.transitionStart(a, m),
                            s.transitionEnd(a, m)) : (s.setTransition(t),
                            s.setTranslate(g),
                            s.updateActiveIndex(n),
                            s.updateSlidesClasses(),
                            s.emit("beforeTransitionStart", t, i),
                    ...
                    slidePrev: function(e, t, a) {
                        ...
                        return void 0 === h && r.cssMode && n.forEach((function(e) {
                                !h && p >= e && (h = e)
                            }
                        )),
                ...
                loop: {
                    ...
                    loopFix: function() {
                        ...
                        a < r ? (t = i.length - 3 * r + a,
                            t += r,
                        e.slideTo(t, 0, !1, !0) && 0 !== d && e.setTranslate((l ? -e.translate : e.translate) - d)) : a >= i.length - r && (t = -i.length + a + r,
                            t += r,
                ...
                events: {
                    attachEvents: function() {
                        ...
                        if (!l.touch && l.pointerEvents)
                            ...
                            if (l.touch) {
                                ...
                                B || (t.addEventListener("touchstart", Y),
                                    B = !0)
                            }
                        ...
                        a.cssMode && n.addEventListener("scroll", e.onScroll),
                            a.updateOnWindowResize ? e.on(o.ios || o.android ? "resize orientationchange observerUpdate" : "resize observerUpdate", N, !0) : e.on("observerUpdate", N, !0)
                    },
                    detachEvents: function() {
                        ...
                        a.cssMode && n.removeEventListener("scroll", e.onScroll),
                            e.off(o.ios || o.android ? "resize orientationchange observerUpdate" : "resize observerUpdate", N)
                    }
                },
                breakpoints: {
                    setBreakpoint: function() {
                        ...
                        if (o && (!o || 0 !== Object.keys(o).length)) {
                            ...
                            if (l && e.currentBreakpoint !== l) {
                                ...
                                c && !u ? (n.removeClass(s.containerModifierClass + "multirow " + s.containerModifierClass + "multirow-column"),
                                    e.emitContainerClasses()) : !c && u && (n.addClass(s.containerModifierClass + "multirow"),
                ...
                classes: {
                    addClasses: function() {
                        var e, t, a, i = this, r = i.classNames, s = i.params, n = i.rtl, o = i.$el, l = i.device, d = i.support, p = (e = ["initialized", s.direction, {
                ...
                images: {
                    loadImage: function(e, t, a, i, r, s) {
                        ...
                        m(e).parent("picture")[0] || e.complete && r ? d() : t ? ((n = new l.Image).onload = d,
                            n.onerror = d,
                        i && (n.sizes = i),
                        a && (n.srcset = a),
                        t && (n.src = t)) : d()
                ...
                , V = function() {
                function t() {
                    for (var e, a, i = arguments.length, r = new Array(i), s = 0; s < i; s++)
                        r[s] = arguments[s];
                    if (1 === r.length && r[0].constructor && r[0].constructor === Object ? a = r[0] : (e = r[0],
                        a = r[1]),
                    a || (a = {}),
                        a = C({}, a),
                    e && !a.el && (a.el = e),
                ...
                return r.emitContainerClasses = function() {
                    ...
                    r.slidesPerViewDynamic = function() {
                        ...
                        if (t.centeredSlides) {
                            for (var o, l = a[s].swiperSlideSize, d = s + 1; d < a.length; d += 1)
                                a[d] && !o && (n += 1,
                                (l += a[d].swiperSlideSize) > r && (o = !0));
                            for (var p = s - 1; p >= 0; p -= 1)
                                a[p] && !o && (n += 1,
                                (l += a[p].swiperSlideSize) > r && (o = !0))
                        } else
                            for (var c = s + 1; c < a.length; c += 1)
                                i[c] - i[s] < r && (n += 1);
                        return n
                    }
                    ,
                    ...
                    r.destroy = function(e, t) {
                        void 0 === e && (e = !0),
                        void 0 === t && (t = !0);
                        var a, i = this, r = i.params, s = i.$el, n = i.$wrapperEl, o = i.slides;
            ...
            var W = {
                update: function(e) {
                    ...
                    m = t.rtlTranslate ? "right" : t.isHorizontal() ? "left" : "top",
                        s ? (g = Math.floor(i / 2) + r + l,
                            w = Math.floor(i / 2) + r + o) : (g = i + (r - 1) + l,
                            w = r + o);
                    ...
                    p === b && c === E && !e)
                        return t.slidesGrid !== h && x !== v && t.slides.css(m, x + "px"),
                    ...
                    for (var P = 0; P < u.length; P += 1)
                        P >= b && P <= E && (void 0 === c || e ? M.push(P) : (P > c && M.push(P),
                        P < p && S.push(P)));
                    M.forEach((function(e) {
                ...
                handle: function(e) {
                    ...
                    var l = n.keyCode || n.charCode
                        ...
                        , f = 38 === l
                        , v = 40 === l;
                    if (!t.allowSlideNext && (t.isHorizontal() && h || t.isVertical() && v || c))
                        return !1;
                    if (!t.allowSlidePrev && (t.isHorizontal() && u || t.isVertical() && f || p))
                        return !1;
                    if (!(n.shiftKey || n.altKey || n.ctrlKey || n.metaKey || i.activeElement && i.activeElement.nodeName && ("input" === i.activeElement.nodeName.toLowerCase() || "textarea" === i.activeElement.nodeName.toLowerCase()))) {
                        ...
                        ((c || h) && !r || (p || u) && r) && t.slideNext(),
                        ((p || u) && !r || (c || h) && r) && t.slidePrev()) : ((p || c || f || v) && (n.preventDefault ? n.preventDefault() : n.returnValue = !1),
                        (c || v) && t.slideNext(),
                        (p || f) && t.slidePrev()),
                            t.emit("keyPress", l)
                    }
                ...
                handle: function(e) {
                    ...
                    var r = a.$el;
                    if ("container" !== a.params.mousewheel.eventsTarget && (r = m(a.params.mousewheel.eventsTarget)),
                    ...
                    (!!a.params.loop || !(l === a.minTranslate() || l === a.maxTranslate())) && a.params.nested && t.stopPropagation(),
                        ...
                        if (T.push(b),
                            S ? (b.direction !== S.direction || b.delta > S.delta || b.time > S.time + 150) && a.mousewheel.animateSlider(b) : a.mousewheel.animateSlider(b),
                ...
                update: function() {
                    ...
                    if (a.el && e.pagination.el && e.pagination.$el && 0 !== e.pagination.$el.length) {
                        ...
                        "bullets" === a.type && e.pagination.bullets && e.pagination.bullets.length > 0) {
                            ...
                            s.length > 1)
                                ...
                                if (c.addClass(a.bulletActiveClass),
                                    a.dynamicBullets) {
                                    for (var h = p.eq(o), f = p.eq(l), v = o; v <= l; v += 1)
                                        p.eq(v).addClass(a.bulletActiveClass + "-main");
                                    if (e.params.loop)
                                        if (u >= p.length - a.dynamicMainBullets) {
                                            ...
                                            h.prev().addClass(a.bulletActiveClass + "-prev").prev().addClass(a.bulletActiveClass + "-prev-prev"),
                                                f.next().addClass(a.bulletActiveClass + "-next").next().addClass(a.bulletActiveClass + "-next-next");
                                    else
                                        h.prev().addClass(a.bulletActiveClass + "-prev").prev().addClass(a.bulletActiveClass + "-prev-prev"),
                                            f.next().addClass(a.bulletActiveClass + "-next").next().addClass(a.bulletActiveClass + "-next-next")
                                }
                        ...
                        if ("fraction" === a.type && (s.find("." + a.currentClass).text(a.formatFractionCurrent(i + 1)),
                        ...
                        "progressbar" === a.type) {
                            ...
                            "horizontal" === E ? T = x : S = x,
                                s.find("." + a.progressbarFillClass).transform("translate3d(0,0,0) scaleX(" + T + ") scaleY(" + S + ")").transition(e.params.speed)
                        }
                ...
                enableDraggable: function() {
                    ...
                    if (e.params.scrollbar.el) {
                        ...
                        l && (o.touch ? (l.addEventListener(i.start, e.scrollbar.onDragStart, d),
                            ...
                            l.addEventListener(i.end, e.scrollbar.onDragEnd, p)) : (l.addEventListener(r.start, e.scrollbar.onDragStart, d),
                            t.addEventListener(r.move, e.scrollbar.onDragMove, d),
                            t.addEventListener(r.end, e.scrollbar.onDragEnd, p)))
                    }
                },
                disableDraggable: function() {
                    ...
                    if (e.params.scrollbar.el) {
                        ...
                        l && (o.touch ? (l.removeEventListener(i.start, e.scrollbar.onDragStart, d),
                            ...
                            l.removeEventListener(i.end, e.scrollbar.onDragEnd, p)) : (l.removeEventListener(r.start, e.scrollbar.onDragStart, d),
                            t.removeEventListener(r.move, e.scrollbar.onDragMove, d),
                            t.removeEventListener(r.end, e.scrollbar.onDragEnd, p)))
                    }
                },
                init: function() {
                    var e = this;
                    if (e.params.scrollbar.el) {
                        ...
                        0 === s.length && (s = m('<div class="' + e.params.scrollbar.dragClass + '"></div>'),
                            r.append(s)),
                            C(t, {
                                $el: r,
                                el: r[0],
                ...
                setTransform: function(e, t) {
                    ...
                    if (n || o ? (n = n || "0",
                        o = o || "0") : this.isHorizontal() ? (n = s,
                        o = "0") : (o = s,
                        n = "0"),
                        n = n.indexOf("%") >= 0 ? parseInt(n, 10) * t * r + "%" : n * t * r + "px",
                ...
                onGestureStart: function(e) {
                    ...
                    s.$slideEl && s.$slideEl.length || (s.$slideEl = m(e.target).closest("." + t.params.slideClass),
                ...
                onTouchMove: function(e) {
                    ...
                    r.isTouched && i.$slideEl)) {
                        r.isMoved || (r.width = i.$imageEl[0].offsetWidth,
                            ...
                            r.startX = T(i.$imageWrapEl[0], "x") || 0,
                            r.startY = T(i.$imageWrapEl[0], "y") || 0,
                ...
                in: function(e) {
                    var t, a, i, r, s, n, l, d, p, c, u, h, f, v, m, g, w = this, y = o(), b = w.zoom, E = w.params.zoom, x = b.gesture, T = b.image;
                    ...
                    x.$imageEl && 0 !== x.$imageEl.length && (x.$slideEl.addClass("" + E.zoomedSlideClass),
                        ...
                        e ? (m = x.$slideEl[0].offsetWidth,
                            ...
                            r = x.$slideEl.offset().top + y.scrollY + g / 2 - a,
                            l = x.$imageEl[0].offsetWidth,
                            d = x.$imageEl[0].offsetHeight,
                            p = l * b.scale,
                            c = d * b.scale,
                            f = -(u = Math.min(m / 2 - p / 2, 0)),
                        ...
                        n > v && (n = v)) : (s = 0,
                            n = 0),
                        x.$imageWrapEl.transition(300).transform("translate3d(" + s + "px, " + n + "px,0)"),
                ...
                loadInSlide: function(e, t) {
                    ...
                    if (void 0 !== e && 0 !== a.slides.length) {
                        ...
                        !r.hasClass(i.elementClass) || r.hasClass(i.loadedClass) || r.hasClass(i.loadingClass) || s.push(r[0]),
                        0 !== s.length && s.each((function(e) {
                                var s = m(e);
                ...
                load: function() {
                    ...
                    if (n.loadPrevNext)
                        if (o > 1 || n.loadPrevNextAmount && n.loadPrevNextAmount > 1) {
                            for (var c = n.loadPrevNextAmount, u = o, h = Math.min(r + u + Math.max(c, u), i.length), f = Math.max(r - Math.max(u, c), 0), v = r + o; v < h; v += 1)
                ...
                setTranslate: function(e, t) {
                    var a, i, r = this, s = r.controller.control, n = r.constructor;
                    function o(e) {
                        var t = r.rtlTranslate ? -r.translate : r.translate;
                        "slide" === r.params.controller.by && (r.controller.getInterpolateFunction(e),
                            i = -r.controller.spline.interpolate(-t)),
                        i && "container" !== r.params.controller.by || (a = (e.maxTranslate() - e.minTranslate()) / (r.maxTranslate() - r.minTranslate()),
                    ...
                    if (Array.isArray(s))
                        ...
                        s instanceof n && t !== s && o(s)
                },
                setTransition: function(e, t) {
                    var a, i = this, r = i.constructor, s = i.controller.control;
                    function n(t) {
                        t.setTransition(e, i),
                    ...
                    if (Array.isArray(s))
                        for (a = 0; a < s.length; a += 1)
                            s[a] !== t && s[a]instanceof r && n(s[a]);
                    else
                        s instanceof r && t !== s && n(s)
                }
            }
                , ie = {
                ...
                , le = {
                setTranslate: function() {
                    var e, t = this, a = t.$el, i = t.$wrapperEl, r = t.slides, s = t.width, n = t.height, o = t.rtlTranslate, l = t.size, d = t.browser, p = t.params.cubeEffect, c = t.isHorizontal(), u = t.virtual && t.params.virtual.enabled, h = 0;
                ...
                onThumbClick: function() {
                    ...
                    if (t) {
                        ...
                        if (!(i && m(i).hasClass(e.params.thumbs.slideThumbActiveClass) || null == a)) {
                            var r;
                            if (r = t.params.loop ? parseInt(m(t.clickedSlide).attr("data-swiper-slide-index"), 10) : a,
                                e.params.loop) {
                                var s = e.activeIndex;
                ...
                update: function(e) {
                    ...
                    if (a) {
                        ...
                        a.params.loop || a.params.virtual && a.params.virtual.enabled)
                            ...
                            for (var f = 0; f < c; f += 1)
                                a.slides.eq(t.realIndex + f).addClass(u)
                    }
                }
            }
                , ue = [q, _, {
